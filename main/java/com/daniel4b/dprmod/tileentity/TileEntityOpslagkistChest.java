package com.daniel4b.dprmod.tileentity;
...
public class TileEntityOpslagkistChest extends TileEntityLockableLoot implements ITickable
{
    ...
    {
    	return this.hasCustomName() ? this.customName : "container.opslagkist_chest";
    }
    ...
    {
    	return new ContainerOpslagkistChest(playerInventory, this, playerIn);
    }
    
    @Override
    public String getGuiID() 
    {
    	return Reference.MOD_ID + ":opslagkist_chest";
    }
	...
	public void update()
	{
		if (!this.world.isRemote && this.numPlayersUsing != 0 && (this.ticksSinceSync + pos.getX() + pos.getY() + pos.getZ()) % 200 == 0)
        {
            ...
            {
                if (entityplayer.openContainer instanceof ContainerOpslagkistChest)
                {
                    if (((ContainerOpslagkistChest)entityplayer.openContainer).getChestInventory() == this)
                    {
