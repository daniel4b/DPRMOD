package com.daniel4b.dprmod.gui.containers;
...
public class ContainerOpslagkistChest extends Container
{
    private final int numRows;
    private final TileEntityOpslagkistChest chestInventory;
    
    public ContainerOpslagkistChest(InventoryPlayer playerInv, TileEntityOpslagkistChest chestInventory, EntityPlayer player)
    {
	...
	public TileEntityOpslagkistChest getChestInventory()
	{
